...
class GeraLabirinto:
    ...
    def campos_iniciais(self, i_random, j_random, lista_coords):
        self.cava_primeiro_campo(i_random, j_random, lista_coords)                      #gera o primeiro ponto
    ...
    def escavacao_loop(self, i_random, j_random, lista_coords):
        ...
        while(lista_coords != []):
            ...
            j_random = local_aleatorio_escolhido[1]
            possui_saida = self.cava_na_posicao(i_random, j_random)
            if(possui_saida == True):                                                   #saida encontrada = sai do loop
                break
            i_random = local_aleatorio_escolhido[2]
            j_random = local_aleatorio_escolhido[3]
            possui_saida = self.cava_na_posicao(i_random, j_random)                     #insere os proximos corredores potenciais em lista_coords (parte final)
            if(possui_saida == True):                                                   #saida encontrada = sai do loop
                break
